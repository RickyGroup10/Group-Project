...
```{r}
new_dataset <- d.dataset[, c("distance", "country", "isVip")]
```
...
### setting distances of NA to average 
```{r}
new_dataset$distance[is.na(new_dataset$distance)] <- 207.23
cor(new_dataset$distance, new_dataset$counts_kisses)
```
