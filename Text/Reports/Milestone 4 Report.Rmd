...
# Normality Test - Ricky's Section
...
# factor is a vip
plot1 <- ggplot(isavip, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Is a VIP - Age") + stat_qq_line()
plot2 <- ggplot(isavip, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Is a VIP - Count of Pictures") + stat_qq_line()
plot3 <-ggplot(isavip, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Is a VIP - Profile visits") + stat_qq_line()
plot4 <- ggplot(isavip, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Is a VIP - Count of Kisses") + stat_qq_line()
plot5 <- ggplot(isavip, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Is a VIP - Distance") + stat_qq_line()
```
...
```{r echo = FALSE}
# factor is a vip
plot6 <- ggplot(isnotavip, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Is not a VIP - Age") + stat_qq_line()
plot7 <- ggplot(isnotavip, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Is not a VIP - Count of Pictures") + stat_qq_line()
plot8 <- ggplot(isnotavip, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Is not a VIP - Profile visits") + stat_qq_line()
plot9 <- ggplot(isnotavip, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Is not a VIP - Count of Kisses") + stat_qq_line()
plot10 <- ggplot(isnotavip, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Is not a VIP - Distance") + stat_qq_line()
```
...
```{r warning = FALSE, echo = FALSE}
# factor Switzerland
plot11 <- ggplot(Switzerland, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Switzerland - Age") + stat_qq_line()
plot12 <- ggplot(Switzerland, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Switzerland - Count of Pictures") + stat_qq_line()
plot13 <- ggplot(Switzerland, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Switzerland - Profile visits") + stat_qq_line()
plot14 <- ggplot(Switzerland, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Switzerland - Count of Kisses") + stat_qq_line()
plot15 <- ggplot(Switzerland, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Switzerland - Distance") + stat_qq_line()
```
...
```{r warning = FALSE, echo = FALSE}
# factor Germany
plot16 <- ggplot(Germany, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Germany - Age") + stat_qq_line()
plot17 <- ggplot(Germany, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Germany - Count of Pictures") + stat_qq_line()
plot18 <- ggplot(Germany, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Germany - Profile visits") + stat_qq_line()
plot19 <- ggplot(Germany, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Germany - Count of Kisses") + stat_qq_line()
plot20 <-ggplot(Germany, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Germany - Distance") + stat_qq_line()
```
...
```{r warning = FALSE, echo = FALSE}
# factor France
plot21 <- ggplot(France, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "France - Age") + stat_qq_line()
plot22 <- ggplot(France, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "France - Count of Pictures") + stat_qq_line()
plot23 <- ggplot(France, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "France - Profile visits") + stat_qq_line()
plot24 <- ggplot(France, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "France - Count of Kisses") + stat_qq_line()
plot25 <- ggplot(France, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "France - Distance") + stat_qq_line()
```
...
```{r warning = FALSE, echo = FALSE}
# factor Italy
plot26 <- ggplot(Italy, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Italy - Age") + stat_qq_line()
plot27 <- ggplot(Italy, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Italy - Count of Pictures") + stat_qq_line()
plot28 <- ggplot(Italy, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Italy - Profile visits") + stat_qq_line()
plot29 <- ggplot(Italy, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Italy - Counts of Kisses") + stat_qq_line()
plot30 <- ggplot(Italy, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Italy - Distance") + stat_qq_line()
```
...
```{r warning = FALSE, echo = FALSE}
# factor Other
plot31 <- ggplot(Other, aes(sample = age)) + stat_qq(size = 0.5) + labs(title = "Other - Age") + stat_qq_line()
plot32 <- ggplot(Other, aes(sample = counts_pictures)) + stat_qq(size = 0.5) + labs(title = "Other - Count of Pictures") + stat_qq_line()
plot33 <- ggplot(Other, aes(sample = counts_profileVisits)) + stat_qq(size = 0.5) + labs(title = "Other - Profile visits") + stat_qq_line()
plot34 <- ggplot(Other, aes(sample = counts_kisses)) + stat_qq(size = 0.5) + labs(title = "Other - Counts of Kisses") + stat_qq_line()
plot35 <- ggplot(Other, aes(sample = distance)) + stat_qq(size = 0.5) + labs(title = "Other - Distance") + stat_qq_line()
```
...
```{r}
plots <- vector('list', length(c(0,1)))
titles <- c("Observations from France, Germany, Italy and Switzerland", "Observatrions from other countries")

for (x in c(0,1)) {
  dating <- lovoo[c("counts_pictures", "counts_profileVisits", "counts_kisses", "country")]
  dating$country[dating$country == "Other"] <- 1
  dating$country[dating$country != "Other"] <- 0
  ...
  geom_vline(xintercept = 0.05, col="red") + xlab("P-value obtained per observation") + ggtitle(titles[x+1])+ ylab("Count of observations")
}
ggarrange(plotlist=plots,ncol = 2, nrow = 1)

unique(dating$country)
